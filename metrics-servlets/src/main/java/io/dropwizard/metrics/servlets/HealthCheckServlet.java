...
public class HealthCheckServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req,
        ...
        final Map<String, HealthCheck.Result> results = getHealthChecks(name);
    ...
    private Map<String, HealthCheck.Result> getHealthChecks(String name) {
        if (name != null) {
            return Collections.singletonMap(name, registry.runHealthCheck(name));
        } else {
